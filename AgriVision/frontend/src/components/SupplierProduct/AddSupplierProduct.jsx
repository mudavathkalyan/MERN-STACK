...
const AddSupplierProduct = () => {
    ...
    // Fetch geocoding coordinates based on the address
    const getGeocode = async (address) => {
        try {
            const { data } = await axios.get(`https://nominatim.openstreetmap.org/search?format=json&limit=1&q=${encodeURIComponent(address)}`)
    ...
    const submitHandler = async (e) => {
        ...
        // Get geocoded coordinates before submitting
        const geocode = await getGeocode(address)

        // Dispatch the action with the geocoded coordinates
        dispatch(createSupplierProduct({
            ...
            phonenumber,
            description,
            latitude: geocode.lat, // include latitude
            longitude: geocode.lon, // include longitude
        }))
