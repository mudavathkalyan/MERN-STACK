                ...
                <MDBContainer className="mt-5 mb-4 text-center text-md-left">
                    <MDBRow className="mt-3">
                        ...
                        <MDBCol md="3" lg="3" xl="4" className="mb-4 dark-grey-text">
                            ...
                            <hr className="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style={{ width: "60px" }} />
                            <p><i className="fa fa-home mr-3" />Rgukt,Basar.</p>
                            <p><i className="fa fa-envelope mr-3" />agrivision@gmail.com</p>
                            <p><i className="fa fa-phone mr-3" />8074695430</p>
                            <p>
                            <i className="fab fa-instagram custom-instagram"> </i>agrivision
                            </p>
                            </MDBCol>
