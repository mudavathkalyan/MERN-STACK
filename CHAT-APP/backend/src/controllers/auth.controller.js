...
export const logout=(req,res)=>{
    ...
    {
        console.log("Error At Logut controller",error.message);
    }
...
export const checkAuth = (req, res) => {
    try {
        // Example of sending a success response with request info (if needed)
        res.status(200).json({ 
            user: req.user // Assuming `req.user` contains user information if middleware added it
        });
    } catch (error) {
